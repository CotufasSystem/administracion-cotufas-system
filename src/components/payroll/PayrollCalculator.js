...
const styles = StyleSheet.create({
  ...
  presetBtn: { flex: 1, minWidth: 140, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: 'rgba(37, 99, 235, 0.08)', borderWidth: 1, borderColor: 'rgba(37, 99, 235, 0.2)', paddingVertical: 10, paddingHorizontal: 10, borderRadius: THEME.radius.md },
  presetTitle: { color: THEME.colors.primaryDark, fontSize: 11, fontWeight: '700', textAlign: 'center' },
