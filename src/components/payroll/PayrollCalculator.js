...
const styles = StyleSheet.create({
  ...
  presetsRow: { flexDirection: 'row', gap: THEME.spacing.md, flexWrap: 'wrap' },
  presetBtn: { flex: 1, minWidth: 160, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: 'rgba(37, 99, 235, 0.08)', borderWidth: 1, borderColor: 'rgba(37, 99, 235, 0.2)', paddingVertical: 10, paddingHorizontal: 12, borderRadius: THEME.radius.md },
  presetBtnActive: { borderColor: THEME.colors.primary, backgroundColor: THEME.colors.primary },
  presetTitle: { color: THEME.colors.primaryDark, fontSize: 12, fontWeight: '700' },
  presetTitleActive: { color: '#ffffff', fontWeight: '900' },
  inputsGrid: { flexDirection: 'row', gap: THEME.spacing.md, flexWrap: 'wrap' },
  inputBox: { flex: 1, minWidth: 120 },
  label: { color: THEME.colors.textMuted, fontSize: 10, fontWeight: '700', marginBottom: 4, textTransform: 'uppercase' },
  textInputWrapper: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f8fafc', borderWidth: 1, borderColor: '#e2e8f0', borderRadius: THEME.radius.md, paddingHorizontal: 10 },
  currencySymbol: { color: THEME.colors.primary, fontSize: 15, fontWeight: '800', marginRight: 4 },
  percentSymbol: { color: THEME.colors.primary, fontSize: 14, fontWeight: '800', marginLeft: 2 },
  textInput: { flex: 1, color: THEME.colors.textMain, fontSize: 14, fontWeight: '700', paddingVertical: 8 },
  switchRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#f8fafc', padding: 12, borderRadius: THEME.radius.md, borderWidth: 1, borderColor: '#e2e8f0' },
  switchLabelBox: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  ...
  metricsBanner: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, backgroundColor: '#f8fafc', padding: 12, borderRadius: THEME.radius.md, borderWidth: 1, borderColor: '#e2e8f0' },
  metricItem: { flex: 1, minWidth: 100 },
  metricLabel: { color: THEME.colors.textMuted, fontSize: 10, fontWeight: '600' },
  metricValue: { color: THEME.colors.textMain, fontSize: 15, fontWeight: '800', marginTop: 2 },
});
