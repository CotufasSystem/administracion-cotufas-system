...
const styles = StyleSheet.create({
  ...
  btnSmall: { paddingVertical: 8, paddingHorizontal: 12, borderRadius: 8, gap: 6 },
  btnText: { fontSize: 13, fontWeight: '800', letterSpacing: 0.2, textAlign: 'center', flexShrink: 1 },
  btnTextSmall: { fontSize: 12, fontWeight: '700', textAlign: 'center', flexShrink: 1 },
